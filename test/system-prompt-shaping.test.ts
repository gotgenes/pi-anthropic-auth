...
test("replaces Pi default prompt body with a minimal neutral prompt", () => {
  ...
  assert.match(shaped, /Use the available tools to answer the user's request\./)
  ...
  assert.doesNotMatch(shaped, /Pi documentation \(read only when the user asks about pi itself/)
