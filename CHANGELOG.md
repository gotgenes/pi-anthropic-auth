...
* bump Claude Code version to 2.1.260 and allow overriding it ([4b4584a](https://github.com/gotgenes/pi-anthropic-auth/commit/4b4584af36c835621b96cc12aa9c236344b57f1b))

### Documentation

* **retro:** add retro notes for issue #54 ([6734df4](https://github.com/gotgenes/pi-anthropic-auth/commit/6734df469311945b53143d9d5bd2f219217eaeaa))
* dispatch the release from the ship prompts ([6270cca](https://github.com/gotgenes/pi-anthropic-auth/commit/6270cca5a8a687a12b817117a34062c6b7a714b8)), closes [#63](https://github.com/gotgenes/pi-anthropic-auth/issues/63)
* document the dispatched git-cliff release ([7a25829](https://github.com/gotgenes/pi-anthropic-auth/commit/7a25829256b5e3bbc39379c9d36bdfbe6c1d1a95)), closes [#63](https://github.com/gotgenes/pi-anthropic-auth/issues/63)
* record the Claude Code version-floor gotcha and -ne repro isolation ([c18194e](https://github.com/gotgenes/pi-anthropic-auth/commit/c18194e171d300fed3e00253702ca6071ef03663))
...
* add git-cliff release configuration ([329c979](https://github.com/gotgenes/pi-anthropic-auth/commit/329c9790c69da19f6abb18a997124b08ae725d4e)), closes [#63](https://github.com/gotgenes/pi-anthropic-auth/issues/63)
* add the git-cliff release scripts ([e1669bf](https://github.com/gotgenes/pi-anthropic-auth/commit/e1669bf3dc634774d3bd1f2e1e0a62d22809bb53)), closes [#63](https://github.com/gotgenes/pi-anthropic-auth/issues/63)

<!-- Entries below this point were generated by release-please, which this
     repository used until 2026-09. Releases are now cut by git-cliff from
     .github/workflows/release.yml. See AGENTS.md. -->
